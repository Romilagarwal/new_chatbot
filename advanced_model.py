...
1. First, review the similar cases from our database
2. Identify patterns and common solutions
3. Provide a structured diagnosis in the EXACT format below

RESPONSE FORMAT:

SIMILAR CASES ANALYSIS:
[Briefly summarize what the past cases tell us about this problem]

ROOT CAUSE:
[Single paragraph - technical analysis based on past cases and current symptoms]

IMMEDIATE ACTIONS:
1. [First specific step based on past successful solutions]
2. [Second specific step]  
3. [Third specific step]

ADDITIONAL SOLUTIONS:
• [Alternative approach from database]
• [Backup solution if immediate actions fail]
